...
public class MediaPickerOpts implements Parcelable {
    ...
    public static final String INTENT_OPTS = "com.example.android.camera2basic.opts";
    public static final String INTENT_RES = "com.example.android.camera2basic.result";

    public final @MediaType
    int mediaType;
    public @ScaleType
    int scaleType;
